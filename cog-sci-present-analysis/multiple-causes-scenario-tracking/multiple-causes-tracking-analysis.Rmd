---
title: "Analysis of Multiple-Causes Tracking Scenario (Follow-up from Study 1)"
...
# setwd("~/Dropbox/8 and above/Emotions and Causal Learning/Analysis/cog-sci-present/multiple-causes-scenario-tracking")
...
The line graphs below compares our model's predictions (normalized) on causal inference against participants' ratings (normalized). Predictions and ratings for the emotion condition are shown on the top row, whereas predictions and ratings for the no-emotion condition are illustrated on the bottom row.
```{r plotting-tracking-plot, fig.height = 8, fig.width=12}
