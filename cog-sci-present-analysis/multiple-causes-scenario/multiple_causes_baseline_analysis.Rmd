...
model_cause <- data.frame(
  ...
  ci_lower_pred = c(0.066975, 0.422, 0.431975,
                    0.019,    0.308, 0.606
                    ),
  ci_upper_pred = c(0.102, 0.485, 0.494,
                    0.04 , 0.363, 0.663
                    ),
  mean_pred = c(0.083125, 0.452375, 0.4645,
                0.029875, 0.33475,  0.635375
                ),
...
model_expectation <- data.frame(
  ...
  Hypothesis = c("Blue Box Only", "Orange Box Only", "Both Boxes",
                "Blue Box Only", "Orange Box Only", "Both Boxes"),
  ci_lower_pred = c(0.246, 0.329, 0.341,
                    0.059, 0.242, 0.621
                    ),
  ci_upper_pred = c(0.3  , 0.388025, 0.401,
                    0.094, 0.298,    0.684
                    ),
  mean_pred = c(0.27275,  0.3575,  0.36975,
                0.077125, 0.26975, 0.653125
                ),
  Subject = c("Model", "Model","Model", "Model","Model", "Model"),
  labels = c("B","B","B",
             "B","B","B"),
...
model_desire <- data.frame(
  ...
  ci_lower_pred = c(0.8135593220338984, 0.6),
  ci_upper_pred = c(0.9661016949152542, 0.8),
  mean_pred = c(0.9005, 0.7),
