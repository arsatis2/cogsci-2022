...
model_cause <- data.frame(
  ...
  ci_lower_pred = c(0.027   , 0.356   , 0.544975,
                    0.025   , 0.381975, 0.522
                    ),
  ci_upper_pred = c(0.051, 0.417, 0.604,
                    0.049   , 0.442   , 0.581025
                    ),
  mean_pred = c(0.038875, 0.387125, 0.574,
                0.036,    0.412875, 0.551125
                ),
...
model_expectation <- data.frame(
  ...
  Hypothesis = c("Blue Box Only", "Orange Box Only", "Both Boxes",
                "Blue Box Only", "Orange Box Only", "Both Boxes"),
  ci_lower_pred = c(0.078, 0.311975, 0.532,
                    0.079, 0.332,    0.512
                    ),
  ci_upper_pred = c(0.116,    0.369, 0.594,
                    0.116025, 0.39,  0.570025
                    ),
  mean_pred = c(0.096375, 0.340125, 0.5635,
                0.097875, 0.36125,  0.540875
                ),
  Subject = c("Model", "Model","Model", "Model","Model", "Model"),
  labels = c("B","B","B",
             "B","B","B"),
...
model_desire <- data.frame(
  ...
  ci_lower_pred = c(0.3559322033898305, 0.3142857142857143),
  ci_upper_pred = c(0.6101694915254238, 0.5428571428571428),
  mean_pred = c(0.47525, 0.43175),
