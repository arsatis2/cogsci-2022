...
The scatter-plot below plots our model's predictions on causal structure, belief, desire, and knowledge against participants' mean ratings (normalized). The error bars represent 95% confidence intervals.
...
The bar graphs below compares our model's predictions on causal and belief inference against participants' mean ratings (normalized). The error bars represent 95% confidence intervals. Participants' ratings are shown as the top row of bar graphs, whereas our model's predictions are illustrated on the bottom row.
...
On belief inference, participants in the emotion condition were more likely to infer that the agent expected the box to turn on the purple bulb ($t(119.57) = 8.68, p < .001$) than participants in the no-emotion condition. From the agent's frustration, participants in the emotion condition inferred that the agent acted in order to turn on the red bulb.
```{r testing-hypotheses-on-expectation-purple}
t.test(exp1 ~ condition, ecl_dat)
```

Additionally, participants in the emotion condition were less likely to infer that the agent expected the box to turn on the red bulb ($t(117.95) = -11.05, p < .001$) than participants in the no-emotion condition. Participants in the no emotion condition assumed that the agent's intended to turn on the red bulb (since there was no negative reaction to the outcome).
...
On desire inference, participants in the emotion condition were more likely to infer that the agent desired the purple bulb to be switched on ($t(117.28) = 8.13, p < .001$) than participants in the no-emotion condition. This is consistent with the belief inferences. The participants inferred that the agent intended to turn on the purple bulb in the emotion condition and conversely the red bulb in the no-emotion condition.
```{r testing-desire-purple}
t.test(desire1 ~ condition, ecl_dat) # bulb1
```

On the other hand, participants in the emotion condition were less likely to infer that the agent desired the purple bulb to be switched on ($t(116.78) = -10.40, p < .001$) than participants in the no-emotion condition. Again, this is consistent with the belief inferences. The participants inferred that the agent intended to turn on the purple bulb in the emotion condition and conversely the red bulb in the no-emotion condition.
...
Finally, with regards to knowledge inference, participants in the emotion condition were less likely to infer that the agent was knowledgeable about the function of the box ($t(122.85) = -2.46, p = 0.02$) than participants in the no-emotion condition. From the agent's frustration, participants in the emotion condition perceived that he made a mistake and hence inferred that he is not highly knowledgeable.
