...
Participants' ratings on the causal relationship between the box and the purple bulb did not statistically differ across conditions.
```{r testing-hypotheses-on-causal-structure-purple}
t.test(relationBlueOne ~ condition, ecl_dat)
```

Participants' ratings on the causal relationship between the box and the red bulb did not statistically differ across conditions.
...
Finally, with regards to knowledge inference, participants in the emotion condition were less likely to infer that the agent was knowledgeable about the function of the box ($t(122.85) = -2.46, p = 0.02$) than participants in the no-emotion condition.
