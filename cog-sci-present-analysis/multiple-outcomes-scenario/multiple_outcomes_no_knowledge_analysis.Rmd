...
model_cause <- data.frame(
  ...
  ci_lower_pred = c(0.7049675202481033,0.874081893573677,
                    0.07580605698682724,0.9078706932673027
                    ),
  ci_upper_pred = c(0.7787474304648706,0.9568416524512763,
                    0.19565513576830457,0.977067583179068
                    ),
  mean_pred = c(0.7421171090538607,0.9213143579815191,
                0.13358455761611066,0.9452515734819681
                ),
...
model_expectation <- data.frame(
  ...
  ci_lower_pred = c(0.7043037054656857,0.8774809092293568,
                    0.07231250783036683,0.9050043642878428
                    ),
  ci_upper_pred = c(0.7761742748150937,0.9596964956037123,
                    0.1997513614994956,0.9760613002504807
                    ),
  mean_pred = c(0.7421171090538607,0.9213143579815191,
                0.13358455761611066,0.9452515734819681
                ),
...
model_desire <- data.frame(
  condition = c("emotion", "emotion", "no-emotion","no-emotion"),
  Hypothesis = c("Purple Bulb", "Red Bulb", "Purple Bulb", "Red Bulb"),
  ci_lower_pred = c(0.832, 0.002, 
                    0.098, 0.825),
  ci_upper_pred = c(0.875   , 0.01, 
                    0.137   , 0.869),
  mean_pred = c( 8.5175e-01, 5.5000e-03, 
                 0.11775,  0.84625
                 ),
  Subject = c("Model", "Model","Model", "Model"),
  labels = c("D", "D","D", "D"),
